...
http://www.flickr.com/photos/radiodepaul/6195446169/
  $('div.slides_container').append('<div class="slide"><a title="' + photo.title + '" href="' + b_url + '" class="fancybox" rel="gallery" ><img src="' + b_url + '" alt="' + photo.title + '" title="' + photo.title + '" width="900px "/></a><div class="caption"><p>' + photo.title + '</p></div></div>');
