    ...
    jQuery.fn.NannuFeed = function(options) {
	  ...
	  'moretip':'Please add more tip'
	    ...
	    if (links == undefined)
			...
			{
			verified=result.url;
		    furl='http://devonblandin.com/getrss.php?url='+verified;		
