...
<body>
	...
	<div id="page">
		...
		<header>
			...
			<h1 id="title">Visiting Dignitaries</h1>
			<nav>
				<a href="/" >Home</a>
		...
		<script type="text/javascript" language="javascript" src="http://api.flickr.com/services/rest/?format=json&#038;method=flickr.photosets.getPhotos&#038;photoset_id=72157627431314949&#038;api_key=0b21f40148824600c049a5eecc241c18"></script>
		</ul>
		</div>
		<div id="sidebar">
			...
			<div class="sidebarBox">
				...
				<div id="fb-root"></div><script src="http://connect.facebook.net/en_US/all.js#xfbml=1"></script><fb:like-box href="http://www.facebook.com/radiodepaul" width="300" show_faces="true" border_color="" stream="false" header="false"></fb:like-box>
			</div>
			<div class="sidebarBox">
